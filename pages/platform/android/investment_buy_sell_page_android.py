""" Implement functions of the Android Investment Buy/Sell Page """
import pages.platform.android.investment_buy_sell_locators_android as locators
from pages.platform.investment_buy_sell_page import InvestmentBuySellPage
from pages.base_pages import AndroidPageType


class InvestmentBuySellPageAndroid(InvestmentBuySellPage, AndroidPageType):
    """ Implement functions of the Android  """
